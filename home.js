...
async function loadUsers() {
    ...
    try {
        ...
        if (window.StatusSystem) {
            const profilesWithStatus = await loadUsersWithStatus(profilesToShow);
...
async function loadUsersWithStatus(profiles) {
    if (!window.StatusSystem) return profiles;
